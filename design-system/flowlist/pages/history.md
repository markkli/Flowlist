...
- Desktop uses a quiet time grid; narrow windows use chronological day lists. Compact empty weeks and omit empty days from the mobile list.
- Blocks reflect recorded start/end instants; breaks never appear as focus. Show exact durations in labels and record details. Very short blocks have a minimum clickable height; overlapping blocks get separate columns.
