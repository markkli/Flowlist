...
function renderTask(task, allTasks, container) {
  ...
  const checkbox = node.querySelector(".task-completed"), title = node.querySelector(".task-title"), progress = node.querySelector(".task-progress"), minutes = node.querySelector(".task-minutes-label"), priority = node.querySelector(".task-priority"), focus = node.querySelector(".start-focus"), add = node.querySelector(".add-subtask"), breakdown = node.querySelector(".break-down"), subtaskForm = node.querySelector(".subtask-form"), subtaskList = node.querySelector(".subtask-list"), suggestions = node.querySelector(".suggestion-list");
